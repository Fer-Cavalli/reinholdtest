<article class="post-item">
    <?php echo (has_post_thumbnail())? '<a href="'.get_the_permalink().'" class="post-item__image"><div class="image-background"><img src="'.get_the_post_thumbnail_url('large').'" alt="" /></div></a>':''; ?>
